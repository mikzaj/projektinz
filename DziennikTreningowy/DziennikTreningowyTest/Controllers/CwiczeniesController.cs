...
namespace DziennikTreningowy.Controllers
{
    public class CwiczeniesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CwiczenieID,IloscPowtorzen,NazwaCwiczenia")] Cwiczenie cwiczenie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CwiczenieID,IloscPowtorzen,NazwaCwiczenia")] Cwiczenie cwiczenie)
        {
